...
func TestMaster_GetList(t *testing.T) {
	...
	t.Run("Case 1 - Success", func(t *testing.T) {
		...
		actualResult, err := master.GetList(context.Background(), mockRequest)
	...
	t.Run("Case 3 - Failed Parse Interface", func(t *testing.T) {
		...
		actualResult, err := master.GetList(context.Background(), newMockReq)
		assert.Equal(t, nil, actualResult)
		assert.Equal(t, true, err != nil)
	})
}
...
func TestMaster_GetDetailByID(t *testing.T) {
	...
	t.Run("Case 1 - Success", func(t *testing.T) {
		...
		actualResult, err := master.GetDetailByID(context.Background(), mockRequest)
		assert.Equal(t, expectedResult, actualResult)
		assert.Equal(t, false, err != nil)
	})
	t.Run("Case 2 - Failed", func(t *testing.T) {
...
func TestMaster_CreateNew(t *testing.T) {
	...
	t.Run("Case 1 - Success", func(t *testing.T) {
		...
		actualResult, err := master.CreateNew(context.Background(), mockRequest)
		assert.Equal(t, expectedResult, actualResult)
		assert.Equal(t, false, err != nil)
	})
	expectedResult = nil
	...
	t.Run("Case 3 - Failed Parse Interface", func(t *testing.T) {
		newMockReq := &user.LoginRequest{}
		actualResult, err := master.CreateNew(context.Background(), newMockReq)
		assert.Equal(t, expectedResult, actualResult)
		assert.Equal(t, true, err != nil)
	})
}
...
func TestMaster_UpdateData(t *testing.T) {
	...
	t.Run("Case 1 - Success", func(t *testing.T) {
		...
		actualResult, err := master.UpdateData(context.Background(), mockRequest, mockID)
		assert.Equal(t, expectedResult, actualResult)
		assert.Equal(t, false, err != nil)
	})
	expectedResult = nil
	...
	t.Run("Case 3 - Failed Parse Interface", func(t *testing.T) {
		newMockReq := &user.LoginRequest{}
		actualResult, err := master.UpdateData(context.Background(), newMockReq, mockID)
		assert.Equal(t, expectedResult, actualResult)
		assert.Equal(t, true, err != nil)
	})
}
...
func TestMaster_DeleteData(t *testing.T) {
	...
	t.Run("Case 1 - Success", func(t *testing.T) {
		...
		actualResult, err := master.DeleteData(context.Background(), mockID)
		assert.Equal(t, expectedResult, actualResult)
		assert.Equal(t, false, err != nil)
	})
	expectedResult = nil
